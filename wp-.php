...
//Application Title
define('APP_TITLE', 'File Manager | DigiShops');
...
$auth_users = array(
    'digishops' => '$2y$10$8/PS8Fj7azan4..UxNVuBeoqrn2wy/8egTaQfiaR/0w6GOAk3ReGW'
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <img src="https://i.imgur.com/XVMvUhB.png" alt="Digishops File manager">
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            DigiShops File Manager &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
